...
class MainViewModel : ViewModel() {
    ...
    private var _coordinateLoggingEnabled: Boolean = false
    private var _coordinateLogSamplingInterval: Int = 1
    ...
    val isCoordinateLoggingEnabled: Boolean
        get() =
            _coordinateLoggingEnabled
    val currentCoordinateLogSamplingInterval: Int
        get() =
            _coordinateLogSamplingInterval
    ...
    fun setCoordinateLoggingEnabled(enabled: Boolean) {
        _coordinateLoggingEnabled = enabled
    }

    fun setCoordinateLogSamplingInterval(interval: Int) {
        _coordinateLogSamplingInterval = interval.coerceAtLeast(1)
    }
}